...
public class ExportacaoDarfIRPJStrategy implements ExportacaoStrategy{
    ...
    public boolean aplicaPara(String descricaoNome) {
        return "DARF IRPJ".equalsIgnoreCase(descricaoNome);
    }
    ...
    public void escreverLancamento(BufferedWriter writer, Lancamento lancamento) throws IOException {
        ...
        linha.append(String.format("\"DARF IRPJ REF COMP: %02d/%04d\"", mes, ano));
