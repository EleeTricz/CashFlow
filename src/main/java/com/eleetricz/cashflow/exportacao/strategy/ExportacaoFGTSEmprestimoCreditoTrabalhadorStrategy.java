...
public class ExportacaoFGTSEmprestimoCreditoTrabalhadorStrategy implements ExportacaoStrategy{
    ...
    public boolean aplicaPara(String descricaoNome) {
        return "EMPRESTIMO CREDITO DO TRABALHADOR".equalsIgnoreCase(descricaoNome);
    }
    ...
    public void escreverLancamento(BufferedWriter writer, Lancamento lancamento) throws IOException {
        ...
        linha.append(String.format("\"EMPRESTIMO CREDITO DO TRABALHADOR - %02d/%04d\"", mes, ano));
