...
public class ExportacaoEncargosDasParcelamentoStrategy implements ExportacaoStrategy{
    ...
    public void escreverLancamento(BufferedWriter writer, Lancamento lancamento) throws IOException {
        ...
        linha.append(String.format("\"%02d/%04d ENCARGOS DAS PARCELAMENTO %s\"", mes, ano, obs));
