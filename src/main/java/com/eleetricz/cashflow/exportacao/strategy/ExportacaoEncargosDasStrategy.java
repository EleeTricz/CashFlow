...
public class ExportacaoEncargosDasStrategy implements ExportacaoStrategy{
    ...
    public boolean aplicaPara(String descricaoNome) {
        return "ENCARGOS DAS".equalsIgnoreCase(descricaoNome);
    }
    ...
    public void escreverLancamento(BufferedWriter writer, Lancamento lancamento) throws IOException {
        ...
        linha.append(String.format("\"%02d/%04d ENCARGOS DAS\"", mes, ano));
