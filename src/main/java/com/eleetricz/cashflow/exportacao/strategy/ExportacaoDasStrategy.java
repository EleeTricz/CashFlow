...
public class ExportacaoDasStrategy implements ExportacaoStrategy {
    ...
    public boolean aplicaPara(String descricaoNome) {
        return "DAS".equalsIgnoreCase(descricaoNome);
    }
    ...
    public void escreverLancamento(BufferedWriter writer, Lancamento lancamento) throws IOException {
        ...
        linha.append(String.format("\"%02d/%04d DAS\"", mes, ano));
