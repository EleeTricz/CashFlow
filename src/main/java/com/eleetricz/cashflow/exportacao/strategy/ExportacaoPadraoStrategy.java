...
public class ExportacaoPadraoStrategy implements ExportacaoStrategy {
    ...
    public boolean aplicaPara(String descricaoNome) {
        return true; // Estratégia padrão para qualquer descrição que não tenha lógica específica
    }
    ...
    public void escreverLancamento(BufferedWriter writer, Lancamento lancamento) throws IOException {
        ...
        linha.append(String.format("\"%02d/%04d\"", mes, ano));
