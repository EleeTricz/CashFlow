...
public class ExportacaoEncargosFGTS13Strategy implements ExportacaoStrategy{
    ...
    public boolean aplicaPara(String descricaoNome) {
        return "FGTS 13º".equalsIgnoreCase(descricaoNome);
    }
    ...
    public void escreverLancamento(BufferedWriter writer, Lancamento lancamento) throws IOException {
        ...
        linha.append(String.format("\"%02d/%04d - ENCARGOS FGTS 13 SALARIO\"", mes, ano));
